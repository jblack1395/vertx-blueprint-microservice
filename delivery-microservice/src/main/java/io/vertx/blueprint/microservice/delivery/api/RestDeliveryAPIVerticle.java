package io.vertx.blueprint.microservice.delivery.api;

import io.vertx.blueprint.microservice.common.RestAPIVerticle;
import io.vertx.blueprint.microservice.delivery.Product;
import io.vertx.blueprint.microservice.delivery.ProductService;
 ...
 * @author Eric Zhao
 */
public class RestDeliveryAPIVerticle extends RestAPIVerticle {

  public static final String SERVICE_NAME = "delivery-rest-api";

  private static final String API_ADD = "/add";
  private static final String API_RETRIEVE_BY_PAGE = "/delivery";
  private static final String API_RETRIEVE_ALL = "/delivery";
  ...
  public RestDeliveryAPIVerticle(ProductService service) {
  ...
  public void start(Future<Void> future) throws Exception {
    ...
    String host = config().getString("delivery.http.address", "0.0.0.0");
    int port = config().getInteger("delivery.http.port", 8100);

package io.vertx.blueprint.microservice.delivery;

import io.vertx.blueprint.microservice.common.BaseMicroserviceVerticle;
import io.vertx.blueprint.microservice.common.service.ExampleHelper;
import io.vertx.blueprint.microservice.delivery.api.RestDeliveryAPIVerticle;
import io.vertx.blueprint.microservice.delivery.impl.ProductServiceImpl;
import io.vertx.core.DeploymentOptions;
import io.vertx.core.Future;
import io.vertx.serviceproxy.ProxyHelper;

import static io.vertx.blueprint.microservice.delivery.ProductService.SERVICE_ADDRESS;
 ...
 * @author Eric Zhao
 */
public class DeliveryVerticle extends BaseMicroserviceVerticle {
  ...
  private Future<Void> deployRestService(ProductService service) {
    ...
    vertx.deployVerticle(new RestDeliveryAPIVerticle(service),
